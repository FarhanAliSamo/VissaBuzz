...
@section('content')	
      ...
      <!-- Contact Page Start -->
      <section class="visasbuzz-contact-page-area section_70">
         <div class="container">
            <div class="row">
               <div class="col-md-5">
                  <div class="contact-left">
                     ...
                     <div class="contact-details">
                        ...
                        <div class="single-contact-btn">
                           <h4>Email Us</h4>
                           <a href="#" class="visasbuzz-btn-2">support@visasbuzz.com</a>
                        </div>
                        <div class="single-contact-btn">
                           <h4>Call Us</h4>
                           <a href="#" class="visasbuzz-btn-2">+(09)-2134-76894-9</a>
                        </div>
