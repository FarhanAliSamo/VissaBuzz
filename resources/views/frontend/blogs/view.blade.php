        ...
        <div class="row">
            ...
            <div class="col-md-8 col-xs-12">
                ...
                <div class="approved-msg">
                   ...
                   <h5>{{$b_value->created_at->format('M j,Y')}}</h5>
                   
                   <h6> {{strip_tags($b_value->bmessage)}} </h6>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                ...
                <div class="leave-message">
                    <form id="save_comments" class="myform" method="post" action="{{route('save_comments')}}/" autocomplete="off" >
    					...
    					<!--<input type="hidden" name="ref_link" value="{{request()->headers->get('referer')}}">-->
                        
    					<input type="hidden" name="inquiry_form_subject" value="{{$blog->title}} Inquiry ">
    					
    					<input type="hidden" id='inquiry_form_product_id' name="inquiry_form_product_id" value="{{$blog->id}}">
