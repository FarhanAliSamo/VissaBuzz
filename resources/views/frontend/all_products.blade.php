			...
			<div class="row">
	            ...
	            <div class="col-md-9 col-sm-12 our-product">
    	              ...
    	              <div class="search-results">
                            ...
                            <li> Haven't found any product? <a class="contact-us" rel="nofollow" href="/contact-us"> Contact Us</a> Now.</li>
                            
                            <li> Need Help? <a href="/contact-us" rel="nofollow">Tell us your searching needs!</a></li>
  ...
  <button class="btn custum-style" onclick="listView()"><i class="fa fa-bars"></i> List</button> 
		...
		<div class="col-lg-4 col-md-6">
						...
						<div class="ori-service">
							...
							<div class="service">
								  <img loading="lazy" class="img-responsive" src="{{get_thumb_url_500('products',$p->thumbnail_img,1)}}">
							</div>
							</a>
