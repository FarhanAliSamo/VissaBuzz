                        ...
                        <div class="filter-box">
                            ...
                            <div id="search-filter" class="left-filter-item collapse navbar-collapse">
                                ...
                                @foreach ($all_industries as $key => $ind)
                                    @if ($ind->parent_id == 0)
                                        <div
                                            class="@if ($ind->id == $industry->id || $industry->parent_id == $ind->id) menu_openeds @endif my_cats cat_level_1s @if ($ind->slug == $industry->slug) p_actives @endif">
                                            <ul class="drop-menu @if ($ind->have_childs == 1) main-arrows @endif">
                                                <li class="@if ($ind->have_childs == 1) parent-li @endif">
                                                    <a class="@if ($ind->have_childs == 1) arrows @endif"
                                                ...
                                                @foreach ($all_industries as $key1 => $ind1)
                                                    @if ($ind1->parent_id == $ind->id)
                                                        <li class="unactivess-p">
                                                            <a class=" activess @if ($ind1->slug == $industry->slug) active_childs @endif"
                                                                href="/product-category/{{ $ind1->slug }}">{{ $ind1->name }}</a>
                                                        </li>
                                                    @endif
                                                @endforeach
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            ...
                                            <div class="ori-service">
                                                ...
                                                <div class="service-texts">
                                                    <h3><a href="{{ getproducturl($p) }}">{{ $p->name }}</a></h3>
                                                </div>
                                            </div>
