               ...
               <div class="col-md-6 col-sm-12 col-xs-12 my-quote">
                ...
                @endif
                 ...
                 <div class="short-descrition-inner" itemprop="short_description">
                        <p >{!! str_replace(' border="0"','border="1"',$product_detail->short_description) !!}</p>
                    </div>
				...
				@foreach($related_products as $key => $product)
                      ...
                      <div class="chance-pros-mainn">
        	               ...
        	               <div class="chance-mainn-1" >
                               ...
                               <img class="img-responsive" src="{{get_thumb_url_500('products',$product->thumbnail_img,1)}}" @if($product->imagetitle != '') alt="{{$product->imagetitle}}" @else alt="{{$product->name}}" @endif>
