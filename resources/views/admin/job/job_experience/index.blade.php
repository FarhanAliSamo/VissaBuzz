    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles mb-4 py-3">
            ...
            <div class="d-flex align-items-center flex-wrap">
                <h3 class="me-auto my-0">Job Experience</h3>
                <div>

                    <a href="javascript:void(0);" data-bs-toggle="modal"
                        data-bs-target=".create-modal-lg" class="btn btn-primary me-3"><i class="fas fa-plus me-2"></i>Add Experience</a>
                </div>
            </div>
        </div>
...
@section('script')
    ...
    // Initialize DataTable using Yajra
     table = $('#example3').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ url('admin/job_experiences/data') }}",  // URL for the DataTable data
        columns: [
            { data: 'id' },
            { data: 'name' },
            { data: 'created_at' },
        ...
        $(document).ready(function(){
            ...
            $('#createForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ url('admin/job_experiences') }}", // Your route URL
                    type: "POST",
                    data: formData,
            ...
            $('#updateForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: `{{ url('admin/job_experiences/${updateId}') }}`, // Your route URL
                    type: "POST",
                    data: formData,
                    success: function(response) {
                        if (response.success) {
        ...
        function destroy(id) {
            ...
            $.ajax({
                url: `{{ url('admin/job_experiences/${id}/delete') }}`, // Your route URL
                type: "GET",
        ...
        function edit(id) {
            ...
            $.ajax({
                url: `{{ url('admin/job_experiences/${id}/edit') }}`, // Your route URL
                type: "GET",
