    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles mb-4 py-3">
            ...
            <div class="d-flex align-items-center flex-wrap">
                <h3 class="me-auto my-0">Job Seniority</h3>
                <div>

                    <a href="javascript:void(0);" data-bs-toggle="modal"
                        data-bs-target=".create-modal-lg" class="btn btn-primary me-3"><i class="fas fa-plus me-2"></i>Add Seniority</a>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog ">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Create Seniority</h5>
    ...
    <div class="modal fade edit-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog ">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Edit Seniority</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal">
                    </button>
                </div>
