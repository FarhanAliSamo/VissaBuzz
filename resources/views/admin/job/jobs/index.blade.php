    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles mb-4 py-3">
            ...
            <div class="d-flex align-items-center flex-wrap">
                <h3 class="me-auto my-0">Jobs Listing</h3>
                {{-- <div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('#example3').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.jobs.data') }}", // URL for the DataTable data
                columns: [
                    { data: 'id' },
                    { data: 'job_title' },
                    { data: 'seniority.name' },
        ...
        $(document).ready(function() {
            ...
            $('#createForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ url('admin/jobs') }}", // Your route URL
                    type: "POST",
                    data: formData,
            ...
            $('#updateForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: `{{ url('jobs/${updateId}') }}`, // Your route URL
                    type: "POST",
                    data: formData,
                    success: function(response) {
                        if (response.success) {
        ...
        function destroy(id) {
            ...
            $.ajax({
                url: `{{ url('admin/jobs/${id}/delete') }}`, // Your route URL
                type: "GET",
