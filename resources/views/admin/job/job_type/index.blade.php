...
@section('script')
    ...
    // Initialize DataTable using Yajra
     table = $('#example3').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ url('job_types/data') }}",  // URL for the DataTable data
        columns: [
            { data: 'id' },
            { data: 'name' },
            { data: 'created_at' },
        ...
        $(document).ready(function(){
            ...
            $('#createForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ url('job_types') }}", // Your route URL
                    type: "POST",
                    data: formData,
            ...
            $('#updateForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: `{{ url('job_types/${updateId}') }}`, // Your route URL
                    type: "POST",
                    data: formData,
                    success: function(response) {
                        if (response.success) {
        ...
        function destroy(id) {
            ...
            $.ajax({
                url: `{{ url('job_types/${id}/delete') }}`, // Your route URL
                type: "GET",
        ...
        function edit(id) {
            ...
            $.ajax({
                url: `{{ url('job_types/${id}/edit') }}`, // Your route URL
                type: "GET",
