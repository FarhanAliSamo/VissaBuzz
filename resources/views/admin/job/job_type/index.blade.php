    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles mb-4 py-3">
            ...
            <div class="d-flex align-items-center flex-wrap">
                <h3 class="me-auto my-0">Job Types</h3>
                <div>

                    <a href="javascript:void(0);" data-bs-toggle="modal"
                        data-bs-target=".create-modal-lg" class="btn btn-primary me-3"><i class="fas fa-plus me-2"></i>Add Type</a>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog ">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Create Job Type</h5>
...
@section('script')
    ...
    // Initialize DataTable using Yajra
     table = $('#example3').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ url('admin/job_types/data') }}",  // URL for the DataTable data
        columns: [
            { data: 'id' },
            { data: 'name' },
            { data: 'created_at' },
        ...
        $(document).ready(function(){
            ...
            $('#createForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ url('admin/job_types') }}", // Your route URL
                    type: "POST",
                    data: formData,
            ...
            $('#updateForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: `{{ url('admin/job_types/${updateId}') }}`, // Your route URL
                    type: "POST",
                    data: formData,
                    success: function(response) {
                        if (response.success) {
        ...
        function destroy(id) {
            ...
            $.ajax({
                url: `{{ url('admin/job_types/${id}/delete') }}`, // Your route URL
                type: "GET",
        ...
        function edit(id) {
            ...
            $.ajax({
                url: `{{ url('admin/job_types/${id}/edit') }}`, // Your route URL
                type: "GET",
