...
class JobController extends Controller
{
 ...
 public function __construct() {
    ...
    public function index()
    {
        ...
        return view('admin.job.jobs.index',compact('industries','seniorities','job_types','job_experiences','countries'));
    }
    ...
    public function show()
    {
        ...
        return DataTables::of($data)
            ...
            ->addColumn('actions', function ($d) {
                return view('admin.job.jobs.action_buttons', compact('d')); // Create a separate view for buttons
            })
            ->make(true);
    }
